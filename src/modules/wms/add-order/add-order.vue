<template>
  <section class="add-receipt">
    <form @submit.stop.prevent="onSubmit('form-1')" data-vv-scope="form-1">
      <article>
        <div class="d-flex">
          <div><h2>Outbound Order Entry</h2></div>
          <div class="ml-auto p-2 mr-5 col-1">
          </div>
        </div>
        <div class="d-flex mt-5">
          <div class="unis-steps current ">
            <span  style="background: #2E323C;" >1</span>Documents</div>
        </div>
        <div class="d-flex flex-wrap mb-4">
          ...
          <div class="col-12">
            <multiple-drag-and-drop
              :is-show="isAttachment"
              :customerId="addOrder.customerId"
              v-model="addOrder.filesIds"
        ...
        <div class="d-flex mt-5">
          <div class="unis-steps current ">
            <span  style="background: #2E323C;" >2</span>Order Info</div>
        </div>
        <div class="d-flex flex-wrap">
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <default-select v-model="addOrder.orderType "
                            :selectdatas="orderTypes"
                            :name="'containerSize'"
            ></default-select>
          </div>
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <baseline-input :placeholder="'Full Name'"
                            v-model="addOrder.purchaseOrderNo"
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <baseline-input :placeholder="'Full Name'"
                            v-model="addOrder.reference"
                            :name="'reference'"
            ></baseline-input>
          </div>
          <div class="col-3 pl-0 mt-4">
            <label>Container Size  </label>
            <default-select v-model="addOrder.containerSize"
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <default-select v-model="addOrder.receiveType"
          ...
          <div class="col-3 pl-0 mt-4">
            <label>Seal  </label>
            <baseline-input v-model="addOrder.sealNo"
          ...
          <div class="col-3 pl-0 mt-4">
            <label></label>
            <label>BOL   </label>
            <baseline-input v-model="addOrder.bolNo"
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <input-select-filter v-model="addOrder.receiptType"
          ...
          <div class="col-3 pl-0 mt-4">
            ...
            <switch-button v-model="addOrder.transload"
                           :disabled="addOrder.istransload"
            ></switch-button>
          </div>

          <div class="col-9 pl-0 mt-4">
            <label>Notes </label>
            <baseline-input v-model="addOrder.notes"
        ...
        <div class="mt-5 mb-5" style="position: relative">
          ...
          <table class="table table-bordered">
            ...
            <tr v-for=" (item, index) in itemLists" :key="item.id">
              ...
              <td class="action-td"
                  @click.stop.prevent=controlActionShow(item.itemSpecId,item.qty,item.unitId,item.state)>
                <h3 class="neutrals">...</h3>
                <button class="nav-box"
                        :class="{'dis-blk': actionShowIndex[item.itemSpecId + item.qty + item.unitId + item.state]}">
          ...
          <button type="button" @click.stop="addItemList()" :disabled="!addOrder.customerId"
                  class="unis-btn unis-btn-primary unis-ex-sm" style="position: absolute; top: -30px; right: 0">
            Add
          </button>
        </div>
...
<style lang="scss" src="./add-order.scss"/>
