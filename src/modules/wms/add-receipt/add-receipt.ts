...
import tlp from "./add-receipt.vue";
...
export default class AddReceipt extends WiseVue {
  facilityId: any = '';
  addReceipt: any = {};
  ...
  mounted() {
    this.addReceipt.isCategory = true;
    this.addReceipt.isLoading = true;
    this.addReceipt.carrier = true;
  ...
  onSelectFacility(facility: any) {
    this.$delete(this.addReceipt, "customerId");
    this.$delete(this.addReceipt, "carrierId");
